...
var sbt_item_1 = require("./contracts/build/sbt-item");
var SbtItemParams_1 = require("./types/SbtItemParams");
var SbtItemAction_1 = require("./types/SbtItemAction");
...
var SbtItem = /*#__PURE__*/function () {
  function SbtItem(address, init, contentResolver) {
    _classCallCheck(this, SbtItem);
    this.address = address;
    this.init = init;
    this.contentResolver = contentResolver;
  }
  return _createClass(SbtItem, [{
    key: "sendDeploy",
    value: function () {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return provider.internal(sender, {
                value: value !== null && value !== void 0 ? value : (0, core_1.toNano)('0.03'),
                bounce: true,
    ...
    key: "getData",
    value: function () {
      var _getData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(provider) {
    ...
    key: "getContent",
    value: function () {
      var _getContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(provider) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              _yield$this$getData = _context3.sent;
            ...
            case 18:
              _context3.t0 = (0, content_2.parseNftContent);
              _context3.next = 21;
    ...
    key: "getActions",
    value: function () {
      var _getActions = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(provider, options) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              return _context4.abrupt("return", transactions.map(function (tx) {
                return (0, SbtItemAction_1.parseSbtItemTransaction)(tx);
              }));
            case 13:
            case "end":
    ...
    value: function createFromConfig(config, code, workchain, contentResolver) {
      var data = sbtItemConfigToCell(config);
      var init = {
        data: data,
        code: code !== null && code !== void 0 ? code : SbtItem.sbtCode
      };
      return new SbtItem((0, core_1.contractAddress)(workchain !== null && workchain !== void 0 ? workchain : 0, init), init, contentResolver);
    }
  }, {
