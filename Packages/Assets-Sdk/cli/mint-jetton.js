...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _yield, sdk, network, sender, _yield$promptForUserI, address, recipient, amount, jetton, jettonMintInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          recipient = _yield$promptForUserI.recipient;
          amount = _yield$promptForUserI.amount;
          jetton = sdk.openJetton(address);
          _context2.next = 15;
          return jetton.sendMint(sender, recipient, amount);
        case 15:
          jettonMintInfo = {
            name: 'Minted Jetton',
