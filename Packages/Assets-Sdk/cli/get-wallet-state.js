...
function _promptForUserInput() {
  _promptForUserInput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
    var _yield$inquirer_1$def, address;
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _yield, client, sender, network, _yield$promptForUserI, address, account, walletInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          _context2.next = 12;
          return client.provider(address).getState();
        case 12:
          account = _context2.sent;
          walletInfo = {
            address: address,
            type: account.state.type,
            balance: (0, core_1.fromNano)(account.balance) + ' TON'
          };
          (0, common_1.printInfo)(walletInfo, network);
        case 15:
        case "end":
