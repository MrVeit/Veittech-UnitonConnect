...
function _promptForUserInput() {
  _promptForUserInput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$inquirer_1$def, collection;
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _collectionContent$im;
    var _yield, sdk, network, _yield$promptForUserI, collectionAddress, collection, collectionData, collectionContent, collectionInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 15:
          collectionContent = _context2.sent;
          collectionInfo = {
            name: collectionContent.name,
            description: collectionContent.description,
            image: (_collectionContent$im = collectionContent.image) === null || _collectionContent$im === void 0 ? void 0 : _collectionContent$im.toString('base64'),
