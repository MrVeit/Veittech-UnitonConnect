...
function _promptForUserInput() {
  _promptForUserInput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
    var _yield$inquirer_1$def, address, owner, name, description, image, formattedImage, formattedDescription;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          owner = _yield$inquirer_1$def.owner;
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var _yield, sdk, network, sender, _yield$promptForUserI, address, owner, name, description, image, collection, uploadedImage, content, contentUrl, _yield$collection$get, index, sbtItem, sbtItemInfo;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          address = _yield$promptForUserI.address;
          owner = _yield$promptForUserI.owner;
          name = _yield$promptForUserI.name;
          description = _yield$promptForUserI.description;
          image = _yield$promptForUserI.image;
          collection = sdk.openSbtCollection(address);
          if (!(image.kind === 'url')) {
            _context3.next = 19;
            break;
          }
        ...
        case 26:
          ...
          _context3.next = 29;
          return (0, common_1.retry)(function () {
            return sdk.storage.uploadFile(content);
          }, {
            name: 'upload image'
          });
        case 29:
          contentUrl = _context3.sent;
          _context3.next = 32;
          return collection.getData();
        case 32:
          _yield$collection$get = _context3.sent;
          index = _yield$collection$get.nextItemIndex;
          _context3.next = 36;
          return collection.sendMint(sender, {
            index: index,
            owner: owner,
        ...
        case 38:
          ...
          (0, common_1.printInfo)(sbtItemInfo, network);
        case 41:
        case "end":
