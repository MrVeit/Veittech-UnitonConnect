...
var jetton_wallet_1 = require("./contracts/build/jetton-wallet");
var types_1 = require("../common/types");
var JettonTransferMessage_1 = require("./types/JettonTransferMessage");
var JettonBurnMessage_1 = require("./types/JettonBurnMessage");
var JettonWalletAction_1 = require("./types/JettonWalletAction");
...
var JettonWallet = /*#__PURE__*/function () {
  ...
  return _createClass(JettonWallet, [{
    ...
    key: "send",
    value: function () {
      var _send = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(provider, sender, recipient, amount, options) {
      ...
      function send(_x4, _x5, _x6, _x7, _x8) {
    ...
    key: "sendBurn",
    value: function () {
      var _sendBurn = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(provider, sender, amount, options) {
        var _options$value2, _options$queryId2, _excessReturn$address2, _options$customPayloa2;
        var excessReturn;
            ...
            case 0:
              ...
              return provider.internal(sender, {
                ...
                body: (0, core_1.beginCell)().store((0, JettonBurnMessage_1.storeJettonBurnMessage)({
                  ...
                  amount: amount,
                  responseDestination: (_excessReturn$address2 = excessReturn === null || excessReturn === void 0 ? void 0 : excessReturn.address) !== null && _excessReturn$address2 !== void 0 ? _excessReturn$address2 : null,
                  customPayload: (_options$customPayloa2 = options === null || options === void 0 ? void 0 : options.customPayload) !== null && _options$customPayloa2 !== void 0 ? _options$customPayloa2 : null
                })).endCell()
              });
            case 3:
            case "end":
      ...
      function sendBurn(_x9, _x10, _x11, _x12) {
    ...
    key: "getData",
    value: function () {
      var _getData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(provider) {
    ...
    key: "getActions",
    value: function () {
      var _getActions = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(provider, options) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 11:
              ...
              return _context5.abrupt("return", transactions.map(function (tx) {
                return (0, JettonWalletAction_1.parseJettonWalletTransaction)(tx);
              }));
            case 13:
            case "end":
    ...
    value: function createFromConfig(config, code, workchain) {
      var data = jettonWalletConfigToCell({
        balance: 0n,
        owner: config.owner,
        jettonMaster: config.jettonMaster,
        jettonWalletCode: code !== null && code !== void 0 ? code : JettonWallet.code
      });
      var init = {
        data: data,
        code: code !== null && code !== void 0 ? code : JettonWallet.code
      };
      return new JettonWallet((0, core_1.contractAddress)(workchain !== null && workchain !== void 0 ? workchain : 0, init), init);
    }
  }, {
