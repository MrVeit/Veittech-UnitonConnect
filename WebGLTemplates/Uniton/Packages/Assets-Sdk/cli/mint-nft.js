...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var _yield, sdk, network, sender, _yield$promptForUserI, address, owner, name, description, image, collection, uploadedImage, content, contentUrl, _yield$collection$get, index, nftItem, nftItemInfo;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          collection = sdk.openNftCollection(address);
          if (!(image.kind === 'url')) {
            _context3.next = 19;
            break;
          }
