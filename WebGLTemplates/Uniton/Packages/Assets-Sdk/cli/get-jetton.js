...
function _promptForUserInput() {
  _promptForUserInput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$inquirer_1$def, jetton;
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _jettonContent$image;
    var _yield, sdk, network, _yield$promptForUserI, jettonAddress, jetton, jettonData, jettonContent, jettonInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          _context2.next = 12;
          return jetton.getData();
        case 12:
          jettonData = _context2.sent;
          _context2.next = 15;
          return jetton.getContent();
        case 15:
          jettonContent = _context2.sent;
          jettonInfo = {
            name: jettonContent.name,
            description: jettonContent.description,
            image: (_jettonContent$image = jettonContent.image) === null || _jettonContent$image === void 0 ? void 0 : _jettonContent$image.toString('base64'),
