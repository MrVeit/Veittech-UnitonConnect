...
function _promptForUserInput() {
  _promptForUserInput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$inquirer_1$def, item;
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _yield, sdk, network, sender, _yield$promptForUserI, nftAddress, nft, _yield$nft$getData, owner, sale, saleData, saleInfo, _yield$inquirer_1$def2, confirm, cancelledSaleInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          return nft.getData();
        case 13:
          _yield$nft$getData = _context2.sent;
          owner = _yield$nft$getData.owner;
          if (owner) {
            _context2.next = 17;
            break;
          }
          throw new Error("NFT ".concat((0, common_1.formatAddress)(nftAddress, network), " is not owned"));
        case 17:
          sale = sdk.openNftSale(owner);
          _context2.next = 20;
          return sale.getData();
        case 20:
        ...
        case 25:
          ...
          confirm = _yield$inquirer_1$def2.confirm;
          if (confirm) {
            _context2.next = 29;
            break;
          }
