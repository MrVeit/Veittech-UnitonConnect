...
Starting with `version 0.5.0`, a jetton **transaction history loading** has been added. This is especially useful to be 1000% sure that `jettons have reached` the recipient.
