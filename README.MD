...
- [ ] Getting current price of Toncoi and Jettons,
- [x] Filter downloaded nft collections by various filters: skam, collection address and so on,
- [x] Convert wallet addresses to different formats and visualize them.
